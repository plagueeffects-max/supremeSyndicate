...
export default function SectorMapInner({ properties }: Props) {
  // Fix Leaflet broken marker icons in webpack/Next.js
  useEffect(() => {
  ...
  const bluePin = L.divIcon({
    className: '',
    html: `<div style="width:22px;height:22px;background:#2563EB;border-radius:50% 50% 50% 0;transform:rotate(-45deg);border:2.5px solid white;box-shadow:0 2px 8px rgba(37,99,235,0.45);"></div>`,
    iconSize: [22, 22],
    iconAnchor: [11, 22],
    popupAnchor: [0, -24],
  })
